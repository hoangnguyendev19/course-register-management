...
<img src="https://res.cloudinary.com/dthusmigo/image/upload/v1716129335/client-server-architecture.jpg" alt="architecture" width="300px" height="100px" />
...
### - Server-side(Back-end): Spring boot, Spring Dataa JPA, MariDB

### Yêu cầu cài đặt

```
Node v18.17.1 hoặc từ bản v18 trở lên
Java JDK 17 trở lên
Maven 3.1.1 trở lên
```
